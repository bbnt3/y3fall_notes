...
\begin{enumerate}
    ...
    \\ $f_1(1), f_2(1), \dots, f_n(1), \dots \to f(1)$ --- \aside{for every $x$, there is a corresponding $N_x$.}
...
\deflabel{1..13}{Left and Right Limit of a Function}
\begin{quote}
...
\deflabel{2.2}{Proabbility Measure (STA347 ver.)}
\begin{quote}
...
\begin{enumerate}
    ...
    \item $P(\phi) = 0$
    \item $\forall E, F \subseteq \Omega$, such that $E \subseteq F, P(E) \leq P(F)$
...
Proof via Def 1.2 - Probability Axioms
